...
from infra_modules import create_vpc, create_instances

# VPC CIDR First and Second Octet
OCTET_ADDRESS = {
    "stg": "10.21",
    "dev": "10.22",
    "uit": "10.23",
...
#    stack_names = [f"{vpc_name}-StagingVPC"]
...
def create_update_vpc_stack(vpc_name, region):
    ...
    hostedzone_name = f"{vpc_name}.infralabs"
